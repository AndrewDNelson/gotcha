                    ...
                    <div class="hidden lg:flex items-center">
                        @foreach ($pages as $page)
                            <a href="{{ route($page['route']) }}" class="font-semibold py-4 px-6 text-black no-underline relative
                                    ...
                                    {{ request()->routeIs($page['route']) ? 'border-b-2 border-indigo-400': ''}}">
                                {{ $page['text'] }}
                            </a>
                        @endforeach
                    </div>
                        ...
                        <ul x-show="open"
                            ...
                            @foreach ($pages as $page)
                                <li x-show="open"
                                    ...
                                    <a href="{{ route($page['route']) }}" class="pt-6 relative block px-7 pb-4 {{ request()->routeIs($page['route']) ? 'bg-indigo-50 border-l-4 border-indigo-400': ''}}">{{ $page['text'] }}</a>
                                </li>
                            @endforeach
                        </ul>
                    @endif
